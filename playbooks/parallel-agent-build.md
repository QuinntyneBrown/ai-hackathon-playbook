...
| Prerequisite | A capability assigned to the team under the [One-day team challenge](one-day-team-challenge.md) workflow (Step 10) |
...
| cross-capability contract | A contract on a boundary between two capabilities, defined and owned outside the team under the [One-day team challenge](one-day-team-challenge.md) workflow (Step 7) and consumed unchanged by the team |
...
When the capability meets its definition of done, integrate it into the central repository through the parent workflow's review-and-merge loop (One-day team challenge, Step 14). Work still open at the end of the day moves into the follow-on development cycle recorded in the working agreement.
